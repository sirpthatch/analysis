...
the same one used across this author's other NYC data projects, for a
consistent look. The categorical pair was checked with the palette validator
before use: worst-pair CVD Delta E 24.7, normal-vision 33.6, both clear of the
floors, and both slots clear 3:1 against the light surface.
